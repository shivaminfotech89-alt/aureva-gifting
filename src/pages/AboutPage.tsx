    ...
    <div className="w-full bg-zinc-50 min-h-screen">
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-zinc-950 text-white">
        ...
        <div className="container max-w-5xl mx-auto px-4 relative z-20 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
          ...
          <h1 className="text-[2rem] md:text-[2.5rem] font-bold font-display mb-8 text-white leading-tight">
            The Art of <br />
      ...
      {/* Content Section */}
      <section className="py-12 bg-white relative z-30 -mt-8 rounded-t-[3rem] shadow-xl">
        <div className="container max-w-[80rem] mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8 order-2 lg:order-1">
              <h2 className="text-[1.75rem] md:text-[2rem] font-bold font-display leading-tight text-zinc-900">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6">
                 <div className="bg-zinc-50 p-6 rounded-xl border border-zinc-100 flex flex-col items-start gap-3">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                <div className="absolute inset-0 bg-amber-500/10 rounded-xl transform translate-x-6 translate-y-6" />
                <div className="rounded-xl overflow-hidden aspect-[4/5] bg-zinc-100 shadow-2xl relative z-10 border border-white">
                  <img 
      ...
      <section className="py-16 bg-zinc-950 text-white border-y border-zinc-800">
        <div className="container max-w-[80rem] mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-[1.75rem] md:text-[2rem] font-display font-bold mb-6 text-white">Why Choose Aureva</h2>
            <p className="text-zinc-400 text-lg">We deliver excellence at every step of the gifting journey.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16">
            <div className="text-center group">
              <div className="h-20 w-20 mx-auto bg-zinc-900 border border-zinc-800 rounded-xl flex items-center justify-center mb-8 group-hover:bg-amber-500 group-hover:border-amber-400 transition-all duration-300 shadow-xl">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-display font-bold mb-4 text-white">Bespoke Curation</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-display font-bold mb-4 text-white">Seamless Logistics</h3>
      ...
      <section className="py-16 bg-zinc-50 relative overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-[1.75rem] md:text-[2.25rem] font-display font-bold mb-8 text-zinc-900">Ready to Experience Aureva?</h2>
          ...
          <div className="flex justify-center gap-6">
            <Link to="/shop" className={buttonVariants({ size: "lg", className: "h-11 px-8 text-lg rounded-xl shadow-xl hover:shadow-amber-500/25 transition-all bg-amber-500 hover:bg-amber-600 text-white" })}>
              Explore Collections <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
            <Link to="/corporate" className={buttonVariants({ size: "lg", variant: "outline", className: "h-11 px-8 text-lg rounded-xl border-zinc-300 text-zinc-700 hover:bg-zinc-100 hover:text-zinc-900 transition-all" })}>
              Corporate Inquiry
            </Link>
          </div>
        </div>
