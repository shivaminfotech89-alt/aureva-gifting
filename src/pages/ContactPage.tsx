...
export default function ContactPage() {
  ...
  return (
    <div className="bg-zinc-50 min-h-screen">
      {/* Premium Banner */}
      <div className="bg-zinc-950 text-white pb-12 pt-24 md:pt-28 md:py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-5xl text-center relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <h1 className="text-[2rem] md:text-[2.5rem] font-bold font-display mb-6 leading-tight">
      ...
      <div className="container mx-auto px-4 py-16 md:py-12 max-w-6xl -mt-16 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start">
          
          {/* Contact Details */}
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-8 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-zinc-100 flex flex-col gap-8">
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-display font-bold text-xl text-zinc-900 mb-1">Phone</h3>
              ...
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h3 className="font-display font-bold text-xl text-zinc-900 mb-1">Email</h3>
            ...
            {/* WhatsApp CTA */}
            <div className="bg-[#25D366] text-white p-8 rounded-xl shadow-lg relative overflow-hidden group hover:shadow-[#25D366]/30 transition-all cursor-pointer" onClick={() => window.open('https://wa.me/919825622421', '_blank')}>
              ...
              <h3 className="font-display font-bold text-2xl mb-2 relative z-10">Chat with us</h3>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-zinc-100 p-8 md:p-12 h-full">
              <div className="mb-10 border-b border-zinc-100 pb-6">
                 <h2 className="text-3xl font-display font-bold text-zinc-900">Send a Message</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2.5">
                    ...
                    <Input id="name" name="name" required placeholder="Jane Doe" className="h-11 bg-zinc-50 border-zinc-200 focus-visible:ring-amber-500 rounded-xl" />
                  </div>
                  <div className="space-y-2.5">
                    <Label htmlFor="email" className="text-zinc-700 font-medium">Email Address <span className="text-red-500">*</span></Label>
                    <Input id="email" name="email" type="email" required placeholder="jane@company.com" className="h-11 bg-zinc-50 border-zinc-200 focus-visible:ring-amber-500 rounded-xl" />
                  </div>
                </div>
                <div className="space-y-2.5">
                  <Label htmlFor="subject" className="text-zinc-700 font-medium">Subject <span className="text-red-500">*</span></Label>
                  <Input id="subject" name="subject" required placeholder="What is this regarding?" className="h-11 bg-zinc-50 border-zinc-200 focus-visible:ring-amber-500 rounded-xl" />
                </div>
                <div className="space-y-2.5">
                ...
                <Button type="submit" size="lg" className="w-full md:w-auto h-11 px-10 text-lg font-bold rounded-xl bg-zinc-900 text-white hover:bg-zinc-800 transition-colors" disabled={loading}>
                  {loading ? (
