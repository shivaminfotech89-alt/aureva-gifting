...
import { ShieldCheck, Truck, ArrowLeft, Heart, Upload, X as XIcon, Edit3, AlertCircle } from 'lucide-react';
    ...
    async function loadProduct() {
      ...
      try {
        if (id.startsWith('sample-')) {
          // No stand-in product. Showing an invented one let a customer add
          // something to their cart that does not exist and cannot be sold.
          setProduct(null);
          setLoading(false);
          return;
        }
